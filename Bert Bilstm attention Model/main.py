...
if __name__ == '__main__':
    ...
    mutil_labels = pretreat.multi_label_data(data1, config.label_list)
    ...
    X_ids_train, X_mask_train, Y_train, X_ids_test, X_mask_test, Y_test = pretreat.bert_train_test_split(X_ids, X_mask, mutil_labels, test_size=0.4, shuffle=True, random_state=1)
    X_ids_valid, X_mask_valid, Y_valid, X_ids_test, X_mask_test, Y_test = pretreat.bert_train_test_split(X_ids, X_mask, mutil_labels, test_size=0.5, shuffle=True, random_state=1)

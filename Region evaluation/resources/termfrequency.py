...
class TermFrequency:
    ...
    def getTimeVillagesAspectsTF(self, data, topk):
    ...
    def getVillagesAspectsTF(self, data, topk):
        villages = data['village'].unique().tolist()
    ...
    def getVillagesTF(self, data, topk):
        villages = data['village'].unique().tolist()
    ...
    def getYearAspectTF(self, data, topk):
